...
<head>
<meta charset="utf-8">
<title>Travelify - Next Trip Step...</title>
				...
				<section id="trip-login">
					<div class="card">
						<div class="card-body">
							<p align="center">
								<div class="hero-unit">
								  <h2>Your Trip has been successfully saved...Next Add Places in your Trip</h2>
								  <p><span class="label label-important">Important Tips</span> While this is not mandatory but we <font color="blue">recommend</font> use Trip Planner to add some places like restaurants, sight seeing tours, poit of interests like establishments
									in your Trip to make a complete Trip and give an idea to other Travelifiers what is your plan to see and they can recommend you some more places and 
									provide you nice helpful tips about the places you are planning to visit.</p>
								  <p>
								    <a href="/travelitrips/tripplan?action=add&tripid=${tripid}" class="btn btn-primary btn-large">Add Places to Your Trip <i class="icon-plus-sign"></i></a>
								  </p>
								  <p>&nbsp &nbsp</p>
								  <h2>Or I'm fine... let's just see what my Travelifier Friends are saying about my upcoming Trip and I'll add places later.. </h2>
									<p> You can always add places in your Trip any time... 
									<a href="/travelitrips/" class="btn btn-warning btn-large">View All Trips</a>
									</p>
								</div>
							</p>
