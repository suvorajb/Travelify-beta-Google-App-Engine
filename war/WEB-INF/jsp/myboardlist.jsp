...
<head>
<meta charset="utf-8">
<title>Travelify - My Board List...</title>
...
<body>
	...
	<header class="jumbotron subhead" id="overview">
		<div class="container-fluid"><h1>My saved TraveliBoards...</h1></div>
	</header>
			...
			<c:forEach items="${boardlist}" var="board">
				...
				<div class="row-fluid">
					...
					<div class="span11">
						...
						<div class="card">
							<div class="card-body">
								<p><h2>${board.boardtitle}</h2> Created On ${board.createddt }</p>
								<p><a href="/traveliboards/updateboard?boardid=${board.boardid}" class="btn btn-danger">Update Board</a> &nbsp;&nbsp;&nbsp;&nbsp;
								<a href="/traveliboards/showboard?boardid=${board.boardid}" class="btn btn-success">View Board</a></p>
							</div>
						</div><!-- card -->
