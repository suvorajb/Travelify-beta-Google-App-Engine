...
<head>
<meta charset="utf-8">
<title>Travelify - Create New Place Board...</title>
...
<body>
			...
			<div class="container-fluid">
				...
				<div class="nav-collapse collapse">
					<ul class="nav">
			            ...
			            <li class="dropdown">
				              <a id="drop1" href="/traveliboards/" role="button" class="dropdown-toggle active" data-toggle="dropdown">TraveliBoard <b class="caret"></b></a>
				              <ul class="dropdown-menu" role="menu" aria-labelledby="drop1">
	...
	<header class="jumbotron subhead" id="overview">
		<div class="container">
			<h1>Create a TraveliBoard with your favourite places...</h1>
			<h2>Just fill up basic information, save it and share...</h2>
		</div>
	</header>
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="span12">
				...
				<!-- basic board ================================================== -->
					<form:form modelAttribute="boardform" method="post" action="${upldurl}"  enctype="multipart/form-data" class="form-horizontal" id="boardform" >
			        <section id="basic-board-info">
						<div class="card">
							<div class="card-body">
								
								<p>	<label><h3>Title of your place board</h3></label>
									<form:input type="text" path="boardtitle" class="span8" placeholder="e.g. Best burger joints in my neighrborhood Eagan, Minnesota" />
								</p>
								<p>	<label class="inline"><h3>Category?</label>	
								...
								<p>	<label><h3>Location? (City or Area Name)</h3></label>
									<form:input type="text" path="location" placeholder="e.g. London, UK" onFocus="javascript: geolocate();" />
									<img src="/resources/img/powered-by-google1.png" />
								</p>
								<p>	<label><h3>Write something about your favourite board</h3></label>
									<form:textarea rows="5" class="field span5" path="boardnote" />
								</p>
								<p><label><h3>Upload Photo of Your TraveliBoard </h3></label> <input type="file" name="featuredPhoto"> 
									<h3>[Got no photo? No problem... open <a href="http://search.creativecommons.org" target="_blank">http://search.creativecommons.org</a> to search royalty free photo 
									for your board, save and upload here. Don't want any photo for your board? don't worry, we'll put Google Maps as featured photo instead]</h3>
								</p>
								<p> <a class="btn btn-primary" href="#nxtmapstyle">Next &raquo;</a></p>
								<p> &nbsp; &nbsp;</p>
							</div>
						</div>
			        </section>
			        ...
			        <div class="row-fluid" id="nxtmapstyle">
							<div class="span12">
									<div class="card">
										<div class="card-heading"><p><h2>Select A Google Map style to show the locations of the clipped places</h2></p></div>
										<div class="card-body">
											<div class="row-fluid">
											 <ul class="thumbnails">
											...
											<p> <a class="btn btn-primary" href="#place-clips">Next &raquo;</a></p>
											<p> &nbsp; &nbsp;</p>
										</div>
									</div>
							</div>
					...
					<div class="row-fluid">
						<div class="bluebox">
							<p><h2>Select the clipped places you want to add in your board... </h2></p>
						</div>
					</div>
								...
								<div class="card paperclip">
									<div class="card-body">
										...
										<p>
											...
											<address>${clip.plcaddrss}</address>
											<form:checkbox path="clippedplaces" value="${clip.plcname};${clip.plcaddrss};${clip.plclatlon}" /> Select
										</p>
									</div>
								</div><!-- card -->
							...
							<div class="span12">
									...
									<div class="card">
										<div class="card-body">
											<p>
											<center>
												<h3>You don't have any clipped places...Search below to find the best places you are looking for. Otherwise use TraveliCity and TraveliNearby to 
												find the places you love...</h3>
											</center>
										</div>
									</div>
							</div>
					...
					<div class="row-fluid">
						<div class="bluebox">
							<p><h2>Search places you like to clip to your board <input type="text" name="searchtxt" id="searchtxt" placeholder="e.g. top rated spa in birmingham, uk " /> &nbsp;&nbsp;
								<button class="btn btn-warning btn-large" type="button" onclick="javascript:  searchPlaces(); return false;">Search &raquo;</button> </h2></p>
						</div>
					</div>
							...
							%>
								...
								%>
									<div class="span3 thumbnail card" id="placecell<%=i%>" style="display:none;">
										...
										<p id="placedtls<%=i%>"><address></address> </p>
			        ...
			        <section id="trip-plan-save">
						<div class="card">
							<div class="card-body">
								<p><h3>Okay, we have got all your TraveliBoard Information...</h3>
								</p>
								<p><h3>Click the button to save and share your TraveliBoard to help others discover new places and share what you love....</h3>
								<p align="center"><button class="btn btn-primary btn-large" type="submit">Save and Share My TraveliBoard <i class="icon-save"></i></button></p>
							</div>
				</section>
...
<!-- Footer ================================================== -->
	...
	var validator = $("#boardform").validate({
			rules: {
				boardtitle: "required",
				location: "required",
				boardnote: "required"
			...
			messages: {
				boardtitle: "Please enter title of your place board",
				location: "Please enter your location",
				boardnote: "Please write something about your TraveliBoard"
			} 
			/*,
