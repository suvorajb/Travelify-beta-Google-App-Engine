...
<body>
	...
	<header class="jumbotron subhead" id="overview">
		<div class="container-fluid"><h2>Discover new places clipped by others... Get inspired by the beautiful Place Boards ... visit <a class="btn btn-warning" href="/traveliboards/">TraveliBoard</a></h2></div>
	</header>

	<div class="container-fluid">


<c:if test="${not empty clipmap}">

<c:forEach items="${clipmap}" var="mapitem">

		<div class="row-fluid">
			<div class="bluebox"><p><h2>Category - ${mapitem.key} </h2></p></div>
		</div>
		...
		<c:if test="${not empty mapitem.value}">
			...
			<c:forEach items="${mapitem.value}" var="clip">
				<%
					if (i == 0) {
					   flgendrow = false;
				%>
					...
					<section id="no-clip">
						<div class="card">
							<div class="card-body">
								<p>
								<center>
									<h3>There is no clip places under this category</h3>
								</center>
							</div>
						</div>
					</section>
