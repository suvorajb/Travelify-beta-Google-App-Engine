...
<header class="jumbotron subhead" id="overview">
	<div class="container">
		<h1>Create A Trip in less than a minute and get tips from friends... <a class="btn btn-large btn-primary" href="/travelitrips/createtrip">Create A New Trip</a> </h1>
	</div>
</header>
											...
											<div class="card">
												   <div class="card-heading image">
												      ...
												      <div class="card-heading-header">
												         ...
												         <span>${trip.publshddatestr} <br/>By ${trip.unickname}</span>
												      </div>
												   </div>
												   <div class="card-body">
												   	  <p><span class="label label-warning">${trip.tripplace}</span> for ${trip.tripduration } days</p>	
												      <p>${trip.tripnote}</p>
												   </div>
												   <div class="card-media">
												     <a class="card-media-container" href="/traveliboards/showboard?boardid=${board.boardid}">
												         <img src="${trip.tripstaticmap}" class="img-polaroid menu_img_style"/>
												     </a>
												   </div>
												   <div class="card-actions">
												      <p>
												      <a class="btn btn-primary" href="/travelitrips/viewtrip?tripid=${trip.tripid}">View Trip</a>
														  ...
														  data-prefilltext="Travelify- ${trip.triptitle} : ${trip.tripnote}" 
												   ...
												   <div class="card-comments">
												      <div class="comments-collapse-toggle">
												         <a data-toggle="collapse" data-target="#c<%=j%>-comments" href="#c<%=j%>-comments">${trip.tipscount} Tips Posted <i class="icon-angle-down"></i></a>
												      </div>
												      
												      <div id="c<%=j%>-comments" class="comments collapse">
												      	<c:if test="${not empty trip.tips }">
												      	<c:forEach items="${trip.tips }" var="tips">
													         <div class="media">
													            <a class="pull-left card-heading image" href="#">
													               <img class="media-object" src="${tips.uprofilestr}" alt="${tips.unickname }"/>
													            </a>
													            <div class="media-body">
													               <h4 class="media-heading">By ${tips.unickname }</h4>
													               <p>${tips.tipsdata }</p>
													            </div>
													         </div>
													     </c:forEach>
					...
					<c:if test="${empty triplist}">
						...
						<section id="no-board">
							<div class="card">
								<div class="card-body">
									<p align="center">
										<h3>There is no trip posted by anyone... Why don't you create a Trip and share to everyone for tips and recommendation from others
										<a class="btn btn-large btn-primary" href="/travelitrips/createtrip">Create A Trip</a>
										</h3>
									</p>
								</div>
							</div>
